<template>
  <div>
    <div @click="mapNavTitleIcon = !mapNavTitleIcon" style="user-select:none;">
      <h3 class="cursor-pointer flex items-center font-normal dim text-white mb-6 text-base no-underline">
          ...
          <svg v-if="!mapNavTitleIcon" style="margin-right: 0; width: 1rem; height:1rem;" t="1602317232981" class="sidebar-icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="8364">
          ...
          <svg v-if="mapNavTitleIcon" style="margin-right: 0; width: 1rem; height:1rem;" t="1602317859146" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="8509">
    ...
    <div v-if="mapNavTitleIcon" style="user-select:none;">
